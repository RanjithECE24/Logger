...
namespace ara {
namespace log {
LoggingFramework::LoggingFramework(sink::LogSink *logSink, LogLevel logLevel)
    : mLogSink{logSink}, mDefaultLogLevel{logLevel} {}

const Logger &LoggingFramework::CreateLogger(std::string ctxId,
...
void LoggingFramework::Log(const Logger &logger, LogLevel logLevel,
...
LoggingFramework *LoggingFramework::Create(std::string appId, LogMode logMode,
                                           LogLevel logLevel,
  ...
  if (logMode == LogMode::kConsole) {
    ...
    LoggingFramework *_result = new LoggingFramework(_logSink, logLevel);
...
LoggingFramework *LoggingFramework::Create(std::string appId,
                                           std::string filePath,
                                           LogLevel logLevel,
                                           std::string appDescription) {
...
LoggingFramework::~LoggingFramework() noexcept { delete mLogSink; }
} // namespace log
} // namespace ara