...
namespace ara {
namespace log {
Logger::Logger(std::string ctxId, std::string ctxDescription,
               LogLevel ctxDefLogLevel)
    : mContextId{ctxId}, mContextDescription{ctxDescription},
...
Logger Logger::CreateLogger(std::string ctxId, std::string ctxDescription,
                            LogLevel ctxDefLogLevel) {
